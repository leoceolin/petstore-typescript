...
Leonel Developer-friendly & type-safe Typescript SDK specifically catered to leverage *petstore* API.
...
<br /><br />
> [!IMPORTANT]
> This SDK is not yet ready for production use. To complete setup please follow the steps outlined in your [workspace](https://app.speakeasy.com/org/avanteer/apps). Delete this section before > publishing to a package manager.
...
* [place](docs/sdks/store/README.md#place) - Place an order for a pet
* [getById](docs/sdks/store/README.md#getbyid) - Find purchase order by ID
* [delete](docs/sdks/store/README.md#delete) - Delete purchase order by ID
...
- [`storeDelete`](docs/sdks/store/README.md#delete) - Delete purchase order by ID
- [`storeGetById`](docs/sdks/store/README.md#getbyid) - Find purchase order by ID
- [`storeGetInventory`](docs/sdks/store/README.md#getinventory) - Returns pet inventories by status
- [`storePlace`](docs/sdks/store/README.md#place) - Place an order for a pet
- [`userCreate`](docs/sdks/user/README.md#create) - Create user
- [`userGet`](docs/sdks/user/README.md#get) - Get user by user name
